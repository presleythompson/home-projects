...
export default function DatePicker({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-1.5 z-30 bg-paper rounded-xl shadow-lg border border-line p-3 w-64">
          <div className="flex items-center justify-between mb-2">
            <button
              onClick={() => step(-1)}
              className="w-7 h-7 rounded-lg text-stone-500 hover:bg-stone-100 transition-colors flex items-center justify-center"
          ...
          {value && (
            <button
              ...
              className="mt-2 w-full rounded-lg px-3 py-1.5 text-[13px] font-medium text-stone-500 hover:bg-stone-100 transition-colors"
            >
              Clear date
            </button>
          )}
